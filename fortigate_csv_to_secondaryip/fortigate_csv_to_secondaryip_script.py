...
with open('fortigate_csv_to_secondaryip_output.txt', 'w') as f:
	f.write('')

### Append first line to output
#with open('fortigate_csv_to_secondaryip_output.txt', 'a') as f:
#    f.write('' + N)

### Read input CSV and assign each column to a variable
with open('fortigate_csv_to_secondaryip_input.csv', 'r') as f:
    for line in f:
        values = line.split(';')        
